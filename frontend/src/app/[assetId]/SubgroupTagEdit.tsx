...
import { AdjustmentsVerticalIcon, BookmarkIcon, PlusCircleIcon} from "@heroicons/react/24/outline";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export default function SubgroupTagEdit() {
  ...
  return (
      <>
      <div className="rounded-md bg-foreground/5 border border-zinc-200 h-full p-5 w-full gap-2 flex flex-col">
        <div className="flex flex-row justify-between w-full">
          ...
          <div className="flex flex-row gap-2">
            ...
            >
                <SelectTrigger className="w-[200px] shadow-none bg-background">
        ...
        <div className="w-full flex flex-row items-center gap-2">
          ...
          />
          <DropdownMenu>
            <DropdownMenuTrigger className="px-2 py-1 flex  h-full bg-background items-center gap-1 border border-zinc-200 rounded-md text-foreground text-sm">
